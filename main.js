...
// handles the animation when moving out of the current page with the vertical lines moving down
...
function scrollReveal() {
  ...
  ScrollReveal().reveal(".header-img-container", {
    origin: "left",
    delay: 1300,
    distance: "1%",
    duration: 1200,
  ...
  ScrollReveal().reveal(".title-and-description .title-and-services", {
    origin: "bottom",
    delay: 1200,
    distance: "2%",
    duration: 1100,
  ...
  ScrollReveal().reveal(".title-and-description .brief", {
    origin: "bottom",
    delay: 1400,
    distance: "2%",
    duration: 1100,
  ...
  ScrollReveal().reveal("#project-number", {
    origin: "left",
    delay: 300,
    opacity: 0,
    distance: "2%",
